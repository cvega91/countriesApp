...
//
//   const countriesResponse = Convert.toCountriesResponse(json);
//
...
export class Convert {
    public static toCountriesResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("CountriesResponse")));
    }

    public static countriesResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("CountriesResponse"))), null, 2);
    }
}
